...
<head>
    ...
    {{ HTML::script('assets/js/vendor/metisMenu.min.js') }}
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        @endif
                        <li>
                            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-sign-out fa-fw"></i> {{ Lang::get('messages.admin.layout.logout') }}</a>
